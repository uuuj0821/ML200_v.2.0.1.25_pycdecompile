...
# Embedded file name: /home/dp110/carima/dp110server/printer/cls_display.py
...
class cls_Display(object):
    ...
    def getLayerPath(self, layer):
        return self.getImagePath('SEC_%04d' % layer)

    def getImagePath(self, baseName):
        return '%s/%s.%s' % (self.imageRoot, baseName, self.fileType)
